<?php
include '../config/database.php';  // Note: TWO dots (..)
...
<head>
    ...
    <style>
        ...
        .page-title {
            ...
            padding-bottom: 10px; border-bottom: 3px solid var(--secondary);
        }
        .btn-edit { background: #ffab00; color: #212529; padding: 5px 15px; border-radius: 5px; text-decoration: none; margin-right: 5px; }
        .btn-delete { background: #dc3545; color: white; padding: 5px 15px; border-radius: 5px; text-decoration: none; }
    </style>
</head>
<body>
    <!-- Sidebar -->
    <div class="sidebar">
        <div class="sidebar-header">
            ...
            <p class="mb-0 small">Manage Users</p>
        </div>
        ...
        <nav class="navbar-top">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <span class="badge bg-primary">Admin: <?php echo $_SESSION['admin_username']; ?></span>
                </div>
            </div>
        </nav>
                    ...
                    <tbody>
                        <?php if($users_result && $users_result->num_rows > 0): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-<?php echo ($user['gender']=='Male')?'primary':(($user['gender']=='Female')?'danger':'secondary'); ?>">
                                        <?php echo $user['gender']; ?>
                                    </span>
                                </td>
                                <td><?php echo htmlspecialchars($user['phone']); ?></td>
                                <td><?php echo substr(htmlspecialchars($user['address']), 0, 30); ?>...</td>
                                <td><?php echo date('d M Y', strtotime($user['created_at'])); ?></td>
                                <td>
                                    <a href="?delete=<?php echo $user['id']; ?>" class="btn-delete btn-sm" 
    ...
    <script>$(document).ready(function() { $('#usersTable').DataTable({ "order": [[0, 'desc']] }); });</script>
</body>
</html>